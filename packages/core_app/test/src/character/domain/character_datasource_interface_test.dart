...
import '../../common/crud_character_interface_test.mocks.dart';
...
void main() {
  ...
  group('ICharacterStorage Tests', () {
    test('saveCharacter saves a character', () async {
    ...
    test('updateCharacterList updates the character list', () async {
      final characters = [
        Character(
          id: 1,
          name: 'Hero',
    ...
    test('updateCharacterLikedStatus updates liked status', () async {
      const id = 1;
      const liked = true;
